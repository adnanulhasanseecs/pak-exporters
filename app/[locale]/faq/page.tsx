...
export async function generateMetadata() {
  ...
  return createPageMetadata({
    title: `${t("title")} - Pak-Exporters`,
    description: t("description") || "Find answers to common questions about Pak-Exporters B2B marketplace, membership tiers, product listings, and more.",
    path: ROUTES.faq || "/faq",
...
export default async function FAQPage() {
  ...
  const breadcrumbs = [
    ...
    { name: t("title"), path: ROUTES.faq || "/faq" },
  ];
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            {t("subtitle") || "Find answers to common questions about Pak-Exporters"}
          </p>
        </div>
        ...
        <Card className="mt-8 bg-primary/5 border-primary/20">
          <CardContent className="p-6 text-center">
            <h3 className="text-xl font-semibold mb-2">{t("stillHaveQuestions") || "Still have questions?"}</h3>
            <p className="text-muted-foreground mb-4">
              {t("supportMessage") || "Can't find the answer you're looking for? Our support team is here to help."}
            </p>
