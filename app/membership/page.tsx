...
export const metadata = {
  title: "Supplier Membership Tiers",
  description: "Learn about our supplier membership tiers: Platinum, Gold, and Silver. Understand the evaluation criteria and benefits of each tier.",
};
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto mb-12">
        <h1 className="text-4xl font-bold mb-4">Supplier Membership Tiers</h1>
        <p className="text-lg text-muted-foreground mb-6">
          Our membership tiers are designed to help buyers identify trusted suppliers while providing
          suppliers with tools to grow their business. Each tier represents a different level of
          verification, experience, and commitment to quality.
        </p>
        <div className="bg-blue-50 dark:bg-blue-950 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mb-8">
          ...
          <p className="text-muted-foreground">
            Our evaluation criteria are inspired by industry leaders like Alibaba, TradeKey, and
            Pak-China. We assess suppliers based on business history, product quality, sales
            performance, customer satisfaction, and verification status. This multi-faceted approach
            ensures buyers can trust the suppliers they work with.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto">
        <Card>
          <CardHeader>
            <CardTitle>How Membership Tiers Work</CardTitle>
            <CardDescription>
              Understanding our tiered system and how suppliers can upgrade
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                All suppliers start with basic verification. Our team reviews business licenses,
                company information, and initial product listings to assign an appropriate tier.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Performance Monitoring</h3>
              <p className="text-sm text-muted-foreground">
                We continuously monitor supplier performance including response rates, order
                fulfillment, buyer feedback, and sales volume. Suppliers can upgrade to higher tiers
                by meeting the criteria.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Tier Upgrades</h3>
              <p className="text-sm text-muted-foreground">
                Suppliers can apply for tier upgrades when they meet the minimum requirements. Our
                verification team conducts a comprehensive review including on-site inspections for
                Platinum tier applicants.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2">Benefits for Buyers</h3>
              <p className="text-sm text-muted-foreground">
                Higher-tier suppliers are more visible in search results and have proven track
                records. Buyers can filter products by supplier tier to find the most trusted
